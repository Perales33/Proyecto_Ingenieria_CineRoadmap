...
public class Pelicula
{
    ...
    private static void cargarPeliculas(ArrayList<Pelicula> catalogo)
    {
        ...
        generos4.add("Aventura"); generos4.add("Ciencia Ficción");
        Vector<String> directores4 = new Vector<>();
        directores4.add("James Cameron");
        Vector<String> actores4 = new Vector<>();
        actores4.add("Sam Worthington"); actores4.add("Zoe Saldana");
        ...
        generos7.add("Ciencia Ficción"); generos7.add("Aventura");
        Vector<String> directores7 = new Vector<>();
        directores7.add("Denis Villeneuve");
        Vector<String> actores7 = new Vector<>();
        actores7.add("Timothée Chalamet"); actores7.add("Zendaya");
        ...
        generos9.add("Comedia"); generos9.add("Ciencia Ficción");
        Vector<String> directores9 = new Vector<>();
        directores9.add("Daniel Kwan"); directores9.add("Daniel Scheinert");
        Vector<String> actores9 = new Vector<>();
        actores9.add("Michelle Yeoh"); actores9.add("Ke Huy Quan");
        ...
        generos10.add("Drama"); generos10.add("Biográfico");
        Vector<String> directores10 = new Vector<>();
        directores10.add("Steven Spielberg");
        Vector<String> actores10 = new Vector<>();
        actores10.add("Gabriel LaBelle"); actores10.add("Michelle Williams");
        ...
        generos12.add("Aventura"); generos12.add("Familia");
        Vector<String> directores12 = new Vector<>();
        directores12.add("Paul King");
        Vector<String> actores12 = new Vector<>();
        actores12.add("Timothée Chalamet"); actores12.add("Olivia Colman");
